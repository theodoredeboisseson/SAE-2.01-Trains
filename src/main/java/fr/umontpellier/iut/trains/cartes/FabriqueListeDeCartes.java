...
public abstract class FabriqueListeDeCartes {
    ...
    public static HashMap<String, Class<? extends Carte>> getDicoCards(){
        return dicoCards;
    }

    public static Carte nomToCarte(String nomCarte) {
        try {
            return dicoCards.get(nomCarte).getDeclaredConstructor().newInstance();
        } catch (NoSuchMethodException | InvocationTargetException | InstantiationException | IllegalAccessException e) {
            System.err.println("Impossible de récupérer la carte");
        }
        return null;
    }
